...
export const INITIAL_TICKETS: SupportTicket[] = [
  ...
  },
  {
    ...
    subject: "Payment debited twice during 6-Month Pro upgrade",
    description: "I upgraded to 6-Month Pro prep yesterday via UPI (Txn ID: UPI9012847). My bank statement shows ₹2,299 debited twice. Please issue a refund for the duplicate transaction.",
    priority: "Urgent",
    status: "Open",
