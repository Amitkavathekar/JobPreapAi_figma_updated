...
const INITIAL_FEATURE_TYPES: AiFeatureType[] = [
  ...
  },
  {
    ...
    name: "ATS Scan",
    description: "High-speed resume parsing, keyword extraction, and match scoring engine.",
...
export default function AiModelsScreen() {
  ...
  return (
    <div style={{ width: "100%", maxWidth: 1100, margin: "0 auto", padding: "10px 0 40px", display: "flex", flexDirection: "column", gap: 24, justifyContent: "center", minHeight: "75vh" }}>
      {/* Toast Notification */}
      {toastMsg && (
        <div
          style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
        <div>
          <h2 style={{ fontSize: 24, fontWeight: 800, color: "white", margin: 0, letterSpacing: "-0.02em" }}>
            🤖 AI Tokens & <span className="gradient-text">Models Router</span>
          </h2>
          <p style={{ color: "rgba(148, 163, 184, 0.7)", fontSize: 13, margin: "4px 0 0" }}>
            Configure and route primary AI models across core application features in real-time.
          </p>
        </div>
        <button
          className="btn-primary"
          onClick={() => setIsAddModalOpen(true)}
          style={{ fontSize: 13, padding: "10px 20px", borderRadius: 12, background: "linear-gradient(135deg, #ec4899, #7c3aed)", fontWeight: 700, boxShadow: "0 4px 15px rgba(236,72,153,0.3)" }}
        >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 22, marginTop: 8 }}>
        {featureTypes.map((ft) => (
          <div
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <div>
                    <h3 style={{ fontSize: 18, fontWeight: 800, color: "white", margin: 0 }}>{ft.name}</h3>
                    <span style={{ fontSize: 11, fontFamily: "JetBrains Mono", color: ft.color, fontWeight: 600 }}>ai_feature_type</span>
                  </div>
                </div>
                <span
                  style={{
              ...
              <p style={{ fontSize: 13, color: "rgba(148, 163, 184, 0.8)", margin: 0, lineHeight: 1.5 }}>
                {ft.description}
              </p>
            </div>

            {/* Selector Controls Box */}
            <div style={{ background: "rgba(7, 7, 26, 0.6)", padding: "16px 18px", borderRadius: 14, border: "1px solid rgba(255,255,255,0.06)", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
              <div>
                <label style={{ fontSize: 11, color: "rgba(148,163,184,0.7)", textTransform: "uppercase", letterSpacing: "0.05em", fontWeight: 700, display: "block", marginBottom: 6 }}>
                  🏢 Provider:
                </label>
                <select
        ...
        >
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
              <h3 style={{ margin: 0, fontSize: 18, color: "white", fontWeight: 800 }}>Register New AI Model</h3>
              <button
